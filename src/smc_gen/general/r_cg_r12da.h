...
/*
    D/A Output Amplifier Control Register (DAAMPCR)
*/
/* Amplifier Control 0 (DAAMP0) */
#define _00_DA_DAAMP0_DISABLE             (0x00U)  /* Output amplifier of channel 0 not used */
#define _40_DA_DAAMP0_ENABLE              (0x40U)  /* Output amplifier of channel 0 is used */
/* Amplifier Control 1 (DAAMP1) */
#define _00_DA_DAAMP1_DISABLE             (0x00U)  /* Output amplifier of channel 1 not used */
#define _80_DA_DAAMP1_ENABLE              (0x80U)  /* Output amplifier of channel 1 is used */
