...
#define _02_ELC_OPERATION_COUNT_STOP                     (0x02U) /* Counting is stopped */
#define _02_ELC_OPERATION_INPUT_CAPTURE                  (0x02U) /* Input capture */
#define _03_ELC_OPERATION_INPUT_CAPTURE                  (0x03U) /* Input capture */
#define _02_ELC_OPERATION_EVENT_COUNTER                  (0x02U) /* Event counter */
#define _03_ELC_OPERATION_EVENT_DISABLE                  (0x03U) /* Event is disabled */
#define _07_ELC_OPERATION_EVENT_DISABLE                  (0x07U) /* Event is disabled */
