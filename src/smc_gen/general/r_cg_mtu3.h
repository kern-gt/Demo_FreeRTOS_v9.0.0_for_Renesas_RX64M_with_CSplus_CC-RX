...
#define _06_MTU_MTCLKA                  (0x06U) /* External clock: counts on MTCLKA pin input (for MTU3,4,8) */
#define _05_MTU_MTCLKB                  (0x05U) /* External clock: counts on MTCLKB pin input (for MTU0,1,2) */
#define _07_MTU_MTCLKB                  (0x07U) /* External clock: counts on MTCLKB pin input (for MTU3,4,8) */
